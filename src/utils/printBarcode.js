  ...
  printWindow.document.write(`
    ...
    <head>
      ...
      <style>
        ...
        .barcode-print-container { width: 100%; margin: 0; padding: 0 0.25rem; display: inline-flex; flex-direction: row; align-items: flex-end; justify-content: center; gap: 0.25rem; box-sizing: border-box; transform: scale(0.35); transform-origin: center center; }
